...
public class Msb
{
    ...
    /// <param name="type">The type of message box to display. Default value is 0.<br/><br/>Possible values are: <br/>
    /// 0 (MB_OK): The message box contains one push button: OK. This is the default.<br/>
    /// 1 (MB_OKCANCEL): The message box contains two push buttons: OK and Cancel.<br/>
    /// 2 (MB_ABORTRETRYIGNORE): The message box contains three push buttons: Abort, Retry, and Ignore.<br/>
    /// 3 (MB_YESNOCANCEL): The message box contains three push buttons: Yes, No, and Cancel.<br/>
    /// 4 (MB_YESNO): The message box contains two push buttons: Yes and No.<br/>
    /// 5 (MB_RETRYCANCEL): The message box contains two push buttons: Retry and Cancel.<br/><br/>
    ...
    /// 16 (MB_ICONHAND): An error-message icon appears in the message box.<br/>
    /// 32 (MB_ICONQUESTION): A question-mark icon appears in the message box.<br/>
    /// 48 (MB_ICONEXCLAMATION): An exclamation-point icon appears in the message box.<br/>
    /// 64 (MB_ICONASTERISK): An information icon appears in the message box.
    /// </param>
